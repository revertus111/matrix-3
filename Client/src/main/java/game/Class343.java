		...
		if (client.aClass613_8605.method7285(1971061836) == null)
			...
			if (bool_13_)
				...
				if (IncomingPacket.method4113((byte) -31) || 625220759 * Class18.anInt143 == 1) {
					int sceneFocusX = (int) class240.aFloat2653 >> 9;
					int sceneFocusY = (int) class240.aFloat2657 >> 9;
					/*
					 * Settlement RTS detaches the rendered camera while the player stays
					 * planted. Matrix3 normally feeds the player's local tile into
					 * Class523.method6240, so scene visibility/fog culling remains centered
					 * on the stationary player. Re-anchor only the settlement RTS render
					 * pass to the detached camera's current local scene tile.
					 */
					if (ConstructionBuildCamera.isSettlementAutoMode()
							&& ConstructionBuildCamera.isRtsMode()
							&& Class24.aClass411_Sub1_158 != null) {
						Class240 rtsPosition = Class24.aClass411_Sub1_158.method4968(-1417293502);
						if (rtsPosition != null) {
							int sceneBaseX = class497.localX * -2109597897 << 9;
							int sceneBaseY = class497.localY * 417324155 << 9;
							sceneFocusX = ((int) rtsPosition.aFloat2653 - sceneBaseX) >> 9;
							sceneFocusY = ((int) rtsPosition.aFloat2657 - sceneBaseY) >> 9;
						}
					}
					client.aClass613_8605.method7285(1098911112).method6240(client.cycles, 2095151347 * class403.anInt4748, -1940941519 * class403.anInt4747, class403.anInt4749 * -101352869, client.aClass613_8605.method7346((byte) 2), client.anIntArray8701, client.anIntArray8716, client.anIntArray8717, client.anIntArray8718, client.anIntArray8719, 1 + (Class611.aClass456_Sub1_Sub2_Sub3_Sub2_7976.aByte9009), i_29_, sceneFocusX, sceneFocusY, Class213.aClass572_Sub24_2463.aClass665_Sub14_9215.method8241((byte) 6) == 0, true, 0, true);
				} else {
