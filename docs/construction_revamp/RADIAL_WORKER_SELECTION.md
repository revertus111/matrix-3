...
- renderer-aware texture enumeration now supports both `AbstractModel.aShortArray10821` and `Class89_Sub2.aShortArray10591`; the first detach implementation only handled AbstractModel
