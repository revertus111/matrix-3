...
Construction Revamp remains the current main workstream. The pre-reset Matrix3 feature/tooling runtime from `8c524fa5949dc436484e49144e736215b42586d4` has been restored on top of current `main`. Restored source presence does not waive any recorded runtime-verification gate.
...
| --- | --- | --- | --- |
| Construction Revamp | `docs/construction_revamp/PROJECT.md` | ACTIVE | Current main workstream. Build Matrix3-native freeform settlement Construction from the protected Matrix3 foundation; legacy 718 implementation remains reference-only. |
...
| Visual Explorer | `docs/visual-explorer/PROJECT.md` | ACTIVE | Unified visual asset explorer + Live Pick. Bundle 1.1 workspace/capture foundation is implemented / needs runtime test; cursor/interaction attribution for the Goblin hover/Attack visual is next. |
...
- Restored source presence does not convert `NEEDS TEST` work into verified runtime behavior.
- Construction remains the current main workstream and must stay Matrix3-native; restored historical systems do not become Construction architecture authority.
