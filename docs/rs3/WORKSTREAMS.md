...
| Dev Mode | `docs/dev-mode/PROJECT.md` | ACTIVE | Phase 1 Bundle 1.2 World Manipulation is active: safe runtime Move/Rotate/Duplicate/Delete-dev-spawn on the verified shared target foundation. |
